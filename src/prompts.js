...
- THIS FORMAT IS NON-NEGOTIABLE`
  ...
  // ============================================================
  // REFLECT MODE (Ideology A: retrieval -> reflection)
  // Instead of a dozen quotes, offer ONE carefully chosen passage
  // to sit with, plus an open question. Depth over volume.
  // ============================================================
  reflectSystem: {
    prompt: `LANGUAGE INSTRUCTION: You MUST follow the language instruction provided in each request. Respond ONLY in the specified language.
...
TRANSLATE ALL content into the user's specified language.`
  },

  // ============================================================
  // SOCRATIC MODE (Ideology B: answers -> questions)
  // The app responds with the questions a tradition would ask the
  // seeker, rather than handing down verdicts. Honest about limits.
  // ============================================================
  socraticSystem: {
    prompt: `LANGUAGE INSTRUCTION: You MUST follow the language instruction provided in each request. Respond ONLY in the specified language.
...
TRANSLATE ALL content into the user's specified language.`
  ...
  // ============================================================
  // COMPARATIVE NOTE (Ideology C: honor difference, not just unity)
  // Appended to ALL-texts requests so the app can show where
  // traditions genuinely DIVERGE, framed with respect.
  // ============================================================
  comparativeNote: `IMPORTANT — HONOR DIFFERENCE, NOT JUST UNITY:
...
Still close with what is shared, but never erase what is distinct.`,

  // ============================================================
  // HUMILITY DISCLAIMER (Ideology D)
  // A short, honest note the UI/response can surface in any mode.
  // ============================================================
  humilityDisclaimer:
    'A gentle note: this is an AI tool, not a spiritual teacher. The words above point toward the sacred texts and traditions — they do not replace them. For matters close to your heart, please return to the source itself and, where you can, to a trusted teacher or community.',
